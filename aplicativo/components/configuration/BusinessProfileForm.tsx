...
import { CIIU_ACTIVITIES, COLOMBIA_CITIES } from "@/lib/constants";
...
export default function BusinessProfileForm({ businessInfo, setBusinessInfo, userId }: BusinessProfileFormProps) {
