...
export function DonTenderoChat() {
    ...
    return (
        <Card className="w-[350px] md:w-[380px] h-[500px] flex flex-col shadow-2xl rounded-2xl overflow-hidden border-0 animate-in slide-in-from-bottom-10 fade-in duration-200">
            {/* Header */}
