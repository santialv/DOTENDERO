-- SCRIPT DE GENERACIÓN DE DATOS DE PRUEBA MASIVOS (CORREGIDO)
-- Para el usuario: santyalvpez@gmail.com
-- Genera: 500 Productos, 100 Clientes, y 200 Ventas históricas.

DO $$
DECLARE
    v_user_email TEXT := 'santyalvpez@gmail.com'; -- CORREGIDO EMAIL
    v_user_id UUID;
    v_org_id UUID;
...
BEGIN
    ...
    -- 3. GENERAR CLIENTES (100) (CORREGIDO: name -> full_name)
    ...
    RAISE NOTICE '💰 Generando % ventas históricas...', v_sales_limit;
